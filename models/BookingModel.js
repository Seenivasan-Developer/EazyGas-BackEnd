...
const BookingSchema = new mongoose.Schema(
    {
        providerdetails: { type: [{providername:{type:String, required:true}}, {providerid:{type:String, required:true}}], require: true },
        ...
        userDetails: { type: [{username:{type:String, required:true}}, {userid:{type:String, required:true}}], require: true },
